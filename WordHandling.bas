...
Public Function lastword(phrase As String, Optional delimeter As String = " ")
    lastword = getword(phrase, countwords(phrase, delimeter) - 1, delimeter)
End Function
...
Public Function findchar(ByVal phrase As String, ByVal character As String, ByVal instance As Integer) As Integer
'locates a specific instance of a character (or string)
Dim count As Integer
Dim Found As Boolean
count = 0
Found = False
Dim spoth As Integer
If instance > 0 Then
...
Public Function getword(phrase As String, number As Integer, Optional delimeter As String) As String
...
Public Function setword(phrase As String, number As Integer, word As String, Optional delimeter As String) As String
...
Public Function containsword(phrase As String, word As String, Optional delimeter As String) As Boolean
...
Public Function countchars(phrase As String, char As String) As Integer
'counts words in a phrase by counting the char_space
Dim spoth As Integer
Dim count As Integer
count = 1   'the first word doesnt have a space before it
For spoth = 1 To Len(phrase)
    If Mid(phrase, spoth, 1) = char Then
        count = count + 1
    End If
Next
countchars = count
End Function
Public Function locofword(phrase As String, number As Integer, start As Boolean, Optional delimeter As String) As Integer
